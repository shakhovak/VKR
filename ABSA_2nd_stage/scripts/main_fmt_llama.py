...
if __name__ == "__main__":
    ...
    ATE_dataset = train_test_split["train"].map(
        preprocess_llama_fmt, fn_kwargs={"prompts_file_path": args.input,
                                         "dataset_task": "ATE"}
    )
    ...
    repository_id = f"{args.model_id_tokenizer.split('/')[1]}-absa-MT-{args.dataset_split}"
