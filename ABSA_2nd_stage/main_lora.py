...
if __name__ == "__main__":
    ...
    repository_id = f"{args.model_id_tokenizer.split('/')[1]}-absa-laptops"
    ...
    # model_flan = AutoModelForSeq2SeqLM.from_pretrained(config.base_model_name_or_path,
    # load_in_8bit=True,
    # device_map={"":0})
    # tokenizer_flan = AutoTokenizer.from_pretrained(config.base_model_name_or_path)
